    ...
    //kick
        ...
        if (args[0] == `${prefix}kick`) {
            ...
            member.kick().then((member) => {
                message.channel.send("Bye Bye! " + member.tag + " has been successfully kicked!").catch(error => message.channel.send("Heck! I couldn't work as intended because of: `" + ` ${error}` + ": Kick Members `."));

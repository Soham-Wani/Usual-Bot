...
client.on("message", async message => {
    ...
    /* Commands */
        ...
        //joke
            ...
            const jokeEmbed = new MessageEmbed().setColor('#0c0c46').setDescription(response.data + `\n`).setFooter(`Generated by \`${prefix}joke\` command. (P.S.: Even I don't understand some jokes!`);

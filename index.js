...
client.on("message", async message => {
    ...
    else if (message.author.id !== client.user.id && message.author.id !== me && message.channel.type !== 'DM' && !message.author.bot && message.content.toLowerCase().startsWith(`pls`) && message.guild.id == 912957696641228830 && !(message.channel.id == 930725102335721533 || message.channel.id == 949238374282182686 || message.channel.id == 954235929051164682 || message.channel.id == 964053665407197204 || message.channel.id == 955459486913544253) ) {

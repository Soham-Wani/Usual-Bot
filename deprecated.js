// Some blocks of code removed from the main code due to some reasons
...
//No commands in DM
if (message.channel.type == 'DM' && message.author.id !== client.user.id && foundInText == false && !message.content.startsWith(prefix)) {
